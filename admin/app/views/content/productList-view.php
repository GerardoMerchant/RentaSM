                                    ...
                                    <div class="d-inline-block text-nowrap">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-dark">
                                            ...
                                            <form class="FormularioAjax" method="POST"
                                                ...
                                                <input type="hidden" name="product_module" value="disableProduct">
                                                <?php

                                                if ($product->status === 3 || $product->status === 1) {
                                                    echo "<input type='hidden' name='id' value= $product->id>";
                                                    echo "<button type='submit' class='dropdown-item'>Habilitar</button>";
                                                    echo "<input type='hidden' name='turn_option' value='2'>";
                                                } else {
                                                    echo "<input type='hidden' name='id' value= $product->id>";
                                                    echo "<button type='submit' class='dropdown-item'>Suspender</button>";
                                                    echo "<input type='hidden' name='turn_option' value='3'>";
                                                }

                                                //<button type="submit" class="dropdown-item">Suspender</button>
                                                ?>
                                            </form>
                                        </div>
                                    </div>
...
<?php
    ...
    include_once "./app/views/inc/no_data.php";
